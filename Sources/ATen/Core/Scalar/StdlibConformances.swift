...
extension Int8:  TorchSignedInteger, TorchInteger, TorchRealNumber, TorchArithmetic, TorchTensorScalar {
...
extension Int16: TorchSignedInteger, TorchInteger, TorchRealNumber, TorchArithmetic, TorchSliceIndex, TorchTensorScalar {
...
extension Int32: TorchSignedInteger, TorchInteger, TorchRealNumber, TorchArithmetic, TorchIndex, TorchSliceIndex, TorchFloatingOrIndex, TorchTensorScalar {
...
extension Int64: TorchSignedInteger, TorchInteger, TorchRealNumber, TorchArithmetic, TorchIndex, TorchSliceIndex, TorchInt64OrString, TorchFloatingOrIndex, TorchTensorScalar {
...
extension UInt8:  TorchUnsignedInteger, TorchInteger, TorchRealNumber, TorchArithmetic, TorchTensorScalar {
...
extension UInt16: TorchUnsignedInteger, TorchInteger, TorchRealNumber, TorchArithmetic, TorchTensorScalar {
...
extension UInt32: TorchUnsignedInteger, TorchInteger, TorchRealNumber, TorchArithmetic, TorchTensorScalar {
...
extension UInt64: TorchUnsignedInteger, TorchInteger, TorchRealNumber, TorchArithmetic, TorchTensorScalar {
