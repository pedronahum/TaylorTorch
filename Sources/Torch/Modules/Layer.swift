...
where
  TangentVector: VectorProtocol & PointwiseMultiplicative & KeyPathIterable
{
...
public struct EmptyTangentVector: EuclideanDifferentiable, VectorProtocol,
...
extension Layer {
    ...
    -> (output: Output, backpropagator: Backpropagator)
  {
    ...
    let (out, pullback) = valueWithPullback(at: self, input) { layer, input in
      return layer(input)
    }
    return (out, pullback)
  }
