...
// Replace the entire computed property implementation.
extension KeyPathIterable {
  public var allKeyPaths: [PartialKeyPath<Self>] {
    var out = [PartialKeyPath<Self>]()
    _forEachFieldWithKeyPath(of: Self.self, options: []) { _, kp in
      out.append(kp)
      return true
    }
    return out
...
extension KeyPathIterable {
  ...
  /// type.
  public func allKeyPaths<T>(to _: T.Type) -> [KeyPath<Self, T>] {
  ...
  /// the specified type.
  public func recursivelyAllKeyPaths<T>(to _: T.Type) -> [KeyPath<Self, T>] {
  ...
  /// specified type.
  public func allWritableKeyPaths<T>(to _: T.Type) -> [WritableKeyPath<Self, T>] {
  ...
  public func recursivelyAllWritableKeyPaths<T>(
    to _: T.Type
